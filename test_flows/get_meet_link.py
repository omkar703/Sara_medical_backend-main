...
def clean_db():
    ...
    try:
        ...
        cur = conn.cursor()
        # Must delete in correct FK order: consultations → patients → users
        cur.execute("""
...
def main():
    ...
    print("
   [STOP] Script paused after creating the meeting link.")
    print("   Please open the link above, have a conversation, and then tell me to continue.")

...
def upgrade() -> None:
    ...
    # Tables may already have been dropped by prior migration - use IF EXISTS
    ...
    # Fix chunks.patient_id foreign key - points to users, should point to patients
    # Drop existing FK if it exists, then recreate pointing to patients
    op.execute("ALTER TABLE chunks DROP CONSTRAINT IF EXISTS chunks_patient_id_fkey")
    op.execute("""
        ALTER TABLE chunks ADD CONSTRAINT chunks_patient_id_fkey_patients
